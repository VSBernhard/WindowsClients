...
C:\Lab\Kurs\Convert-WindowsImage.ps1 -SourcePath $WimFile -Edition $Edition -VHDPath $OutPutVHDXFile -VHDFormat VHDX -VHDType Dynamic -VHDPartitionStyle GPT -SizeBytes 240GB
...
$WimFile = "C:\Lab\Kurs\WindowsServer2022Standard.wim"
$Edition = "Windows Server 2022 Standard (Desktopdarstellung)"
$OutPutVHDXFile = "C:\Lab\Kurs\Master_Server2022.vhdx"
